...
export const managers = [
     {
       ...
       "location": "Ronkonkoma", // (optional)
       "bio": "Lorem ipsum...",
       "photo": null, // "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
